...
public class ThirdDesign extends BaseFragment {
    ...
    private int score = 0;
    private ThirdDesignListener listener;
    ...
    public interface ThirdDesignListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_third_design, container, false);
    ...
    public void setThirdDesignListener(ThirdDesignListener listener) {
